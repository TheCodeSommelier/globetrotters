...
ActiveRecord::Schema[7.1].define(version: 2023_12_04_112955) do
  ...
  create_table "journeys", force: :cascade do |t|
    ...
    t.string "currency"
    t.time "time_zone"
    t.text "packing_list", default: [], array: true
    t.text "notes"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.float "latitude"
  ...
  create_table "saved_experiences", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["experience_id"], name: "index_saved_experiences_on_experience_id"
    t.index ["journey_id"], name: "index_saved_experiences_on_journey_id"
  end
